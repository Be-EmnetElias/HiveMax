...
public class BishopRookQueenTest {
    ...
    public List<Move> GenerateSlidingPieceMove(Board board, boolean isWhite, PieceType piece, long slidingPieces){
    ...
    public void QueenMoves_Default(){
        ...
        assertTrue(expectedMoves.containsAll(GenerateSlidingPieceMove(board, true, PieceType.WHITE_QUEEN, board.WHITE_QUEENS)));
    ...
    public void RookMoves_Default(){
        ...
        assertTrue(expectedMoves.containsAll(GenerateSlidingPieceMove(board,true,PieceType.WHITE_ROOK,board.WHITE_ROOKS)));
    }
    ...
    public void BishopMoves_Default(){
        ...
        assertTrue(expectedMoves.containsAll(GenerateSlidingPieceMove(board,true,PieceType.WHITE_BISHOP,board.WHITE_BISHOPS)));
